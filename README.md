...
# Working:
Here we will talk about the brief understanding of how the software works and all the modules/dependencies used to build the software. ![Flowchart for Network-Analysis Flow Procces](Flow_procces.png) this diagram , a flowchart, simplifying the Network analysis process flow into 10 steps. 
